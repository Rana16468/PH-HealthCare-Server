...
const fetchDashboardMetaData = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Meta_services_1.MetaService.fetchDashboardMetaData({ email, role });
    (0, sendRespone_1.default)(res, { success: true, status: http_status_codes_1.default.OK, message: "Successfully Fetch", data: result });
}));
